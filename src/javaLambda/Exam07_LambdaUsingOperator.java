 ...
 * 입력 매개변수가 있고 리턴값이 있어요
 * Function은 mapping 용도로 많이 사용되요. ( 입력 매개변수를 리턴타입으로 변환,매핑의 용도 )
 * Operator는 연산용도로 많이 사용되요. ( 입력 매개변수를 이용하여 같은 타입의 리턴값을 돌려주는 형태로 사용 )
 * 
